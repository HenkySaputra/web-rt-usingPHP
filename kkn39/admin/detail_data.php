              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <div>
                          <a href="edit_data.php?id=<?php echo $r2['kk_id'] ?>" class="btn btn-success"> <i class="fas fa-edit"></i> </a> |
                          <a href="hapus_data.php?idd=<?php echo $r2['kk_id'] ?>" class="btn btn-danger" onclick="return sweet()"><i class=" fas fa-trash-alt"></i> </a>
                        </div>
                      </td>
                    </tr>
                  <?php }
